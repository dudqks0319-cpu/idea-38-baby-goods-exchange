...
import 'package:app_38_baby_goods_exchange/app.dart';
import 'package:app_38_baby_goods_exchange/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('육아용품 중고 교환'), findsWidgets);
